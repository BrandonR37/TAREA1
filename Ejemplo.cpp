...
// Ejemplo.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CEjemploApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CEjemploApp

CEjemploApp::CEjemploApp()
{
...
// Único objeto CEjemploApp

CEjemploApp theApp;


// Inicialización de CEjemploApp

BOOL CEjemploApp::InitInstance()
{
